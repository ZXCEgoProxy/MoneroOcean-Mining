...
4. In the Railway project settings, set the environment variables (MINING_POOL, WALLET_ADDRESS, RIG_ID) as needed.
...
MINING_POOL=gulf.moneroocean.stream:10004 WALLET_ADDRESS=your_wallet_address RIG_ID=your_rig_id ./start.sh
```
